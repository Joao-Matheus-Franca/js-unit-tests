...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    // ```
    expect(createMenu({ food: {} }).fetchMenu()).toEqual({ food: {} });
    ...
    // ```
    createMenu({}).order("salada");
    expect(createMenu({}).consumption).toEqual(["salada"]);
    ...
    expect(createMenu({}).consumption).toEqual(["salada", "coxinha", "agua", "sopa"]);
    ...
    // ```
    createMenu({}).order("coxinha");
    expect(createMenu({}).consumption).toEqual(["salada", "coxinha", "agua", "sopa", "coxinha"]);
    ...
    // ```
    expect(createMenu({}).pay()).toBeCloseTo(55)
